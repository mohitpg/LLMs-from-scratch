...
NUMBER_OF_FILES=10 #Number of stories in AO3's page -> Max value 40

# Harry Potter fanfics sorted my hits
...
for i in range(NUMBER_OF_FILES):   
    ...
    url=baseurl+'works/'+s[1]+"?view_full_work=true" #To extract all text at once
    time.sleep(5) #Backend scraping cooldown time
